...
# datos iris
data <- summary(iris)
knitr::kable(data, align= 'c', # alinea las columnas al centro
             col.names= c("Largo del sépalo", "Ancho del sépalo", "Largo del pétalo", "Ancho del pétalo", "Especies"), #Nombra las columnas
             caption = "Resumen estadístico de la BBDD Iris" ) # titulo de la tabla
